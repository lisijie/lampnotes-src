        ...
        <div class="content">
            ...
            <form class="form-horizontal" role="form" method="post" action="<?= URL('user/profile/password') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="password" name="newpassword" class="form-control" id="setting-newpassword"
                               required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="password" name="newpassword2" class="form-control" id="setting-newpassword2"
                               required>
                    </div>
                </div>
                <div class="form-group">
