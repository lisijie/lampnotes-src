        ...
        <fieldset>
            <legend>注册</legend>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="<?=$userName?>" required="" name="username" id="username" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="<?=$email?>" required="" name="email" id="email" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="password" class="form-control" id="password2" required="" name="password2" placeholder="" />
